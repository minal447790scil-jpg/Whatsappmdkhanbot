...
const commands = {
    sticker: require('./commands/sticker'),
        ...
        askAI: require('./commands/ai').askAI,
...
if (
    ...
    try {
        ...
        // Remove WhatsApp @number mentions from the
        // message before sending it to Gemini.
        ...
        const aiPrompt =
            ...
            `User message: ${cleanBody}\n\n` +
            `Reply naturally and briefly in the same language ` +
            `as the user. You may use the user's name naturally ` +
            `if appropriate, but NEVER use @mentions, @username, ` +
            `phone numbers, JIDs, WhatsApp IDs, or raw numbers. ` +
            `Do not output any @ symbol for the user's name. ` +
            `Do not reveal internal IDs or internal reasoning.`;

        console.log(
            `[GEMINI AI] ${senderName}: ${cleanBody}`
        );
    ...
    await commands.askAI(aiPrompt);
        ...
        // ==================================================
        // REMOVE @MENTIONS FROM AI RESPONSE
        // ==================================================
        ...
        if (isGroup) {
            ...
            // IMPORTANT:
            // NO "mentions" FIELD HERE.
            //
            // This means:
            // ❌ No @Salman in AI text
            // ❌ No actual WhatsApp mention
            // ✅ Quoted/slide message remains
            // ✅ WhatsApp itself shows the sender/message
            //    in the quoted slide.
        ...
        console.log(
            `[GEMINI AI] Reply sent successfully to ${senderName}`
        );

        // Don't continue into command parser
        return;
