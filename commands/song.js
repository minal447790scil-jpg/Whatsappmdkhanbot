...
async function songCommand(sock, chatId, message) {
    try {
        ...
        // Send song info immediately after search
        await sock.sendMessage(
            chatId,
            {
                image: {
        ...
        console.log('[Song] ✅ Got download URL.');

        // Download only once, with keep-alive and compressed request handling.
        // The returned Buffer is then sent directly to WhatsApp.
        ...
        if (!audioBuffer.length || audioBuffer.length < 10000) {
